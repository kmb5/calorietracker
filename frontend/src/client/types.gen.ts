...
export type SearchIngredientsIngredientsSearchGetResponse = Array<IngredientSearchResult>;
...
export type PromoteIngredientIngredientsIngredientIdPromotePostResponse = IngredientDetail;

export type ListPromotionsAdminIngredientsPromotionsGetResponse = Array<IngredientDetail>;

export type ApprovePromotionAdminIngredientsPromotionsIngredientIdApprovePostData = {
    ingredientId: number;
};

export type ApprovePromotionAdminIngredientsPromotionsIngredientIdApprovePostResponse = IngredientDetail;
...
export type RejectPromotionAdminIngredientsPromotionsIngredientIdRejectPostResponse = IngredientDetail;
...
export type UpdateAnyIngredientAdminIngredientsIngredientIdPatchResponse = IngredientDetail;
...
export type BulkImportIngredientsAdminIngredientsBulkImportPostResponse = BulkImportResult;
...
export type DuplicateRecipeRecipesRecipeIdDuplicatePostResponse = RecipeDuplicateResponse;
