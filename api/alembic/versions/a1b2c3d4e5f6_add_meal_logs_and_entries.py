"""add meal_logs and meal_log_entries tables with calendar index
...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_meal_log_entries_meal_log_id", "meal_log_entries", ["meal_log_id"]
    )
    # Composite index for calendar aggregation queries: (user_id, logged_date)
    op.create_index(
        "ix_meal_log_entries_user_logged_date",
        "meal_log_entries",
        ["user_id", "logged_date"],
    )
...
def downgrade() -> None:
    op.drop_index("ix_meal_log_entries_user_logged_date", table_name="meal_log_entries")
    op.drop_index("ix_meal_log_entries_meal_log_id", table_name="meal_log_entries")
